...
public class MapUtilAndroidTest {
    ...
    public void TestIntersections() {
        ...
        populateData1(p1);
        populateData2(p2);
        List<List<LatLng>> intersectionsPolygons = new ArrayList<>(MapUtil.intersections(p1,p2));
    ...
    public void TestUnions() {
        ...
        populateData1(p1);
        populateData2(p2);
        List<LatLng> unionsPolygons = new ArrayList<>(MapUtil.union(p1,p2));
    ...
    public void TestDifference1() {
        ...
        populateData1(p1);
        populateData2(p2);
        List<LatLng> unionsPolygons = new ArrayList<>(MapUtil.difference(p1,p2));
    ...
    public void TestDifference2() {
        ...
        populateData1(p1);
        populateData2(p2);
        List<LatLng> unionsPolygons = new ArrayList<>(MapUtil.difference(p2,p1));
    ...
    public void TestEquals1() {
        ...
        populateData1(p1);
        assertTrue(MapUtil.equals(p1, p1));
    }
    @Test
    public void TestEquals2() {
        ...
        populateData1(p1);
        populateData2(p2);
        assertFalse(MapUtil.equals(p2, p1));
    }
    @Test
    ...
    public void TestDisjoint1() {
        List<LatLng> p1 = new ArrayList<>();
        populateData1(p1);
        assertFalse(MapUtil.disjoint(p1, p1));
    }
    @Test
    public void TestDisjoint2() {
        ...
        populateData1(p1);
        populateData2(p2);
        assertFalse(MapUtil.disjoint(p2, p1));
    }
    @Test
    public void TestDisjoint3() {
        ...
        populateData1(p1);
        populateData3(p2);
        assertTrue(MapUtil.disjoint(p2, p1));
    }
    @Test
    ...
    public void TestDistanceBetween1() {
        List<LatLng> p1 = new ArrayList<>();
        populateData1(p1);
        assertEquals(0, MapUtil.distanceBetween(p1, p1),0);
    }
    @Test
    public void TestDistanceBetween2() {
        ...
        populateData1(p1);
        populateData2(p2);
        assertEquals(0, MapUtil.distanceBetween(p2, p1),0);
    }
    @Test
    public void TestDistanceBetween3() {
        ...
        populateData1(p1);
        populateData3(p2);
        assertNotEquals(0, MapUtil.distanceBetween(p2, p1),0);
    }
    @Test
    ...
    public void TestArea1() {
        List<LatLng> p1 = new ArrayList<>();
        populateData1(p1);
        assertNotEquals(0, MapUtil.area(p1),0);
    }
    @Test
    ...
    public void TestLength1() {
        List<LatLng> p1 = new ArrayList<>();
        populateData1(p1);
        assertNotEquals(0, MapUtil.length(p1),0);
    }
    @Test
    ...
    public void TestSimplify1() {
        List<LatLng> p1 = new ArrayList<>();
        populateData1(p1);
        assertEquals(p1.size(), MapUtil.simplify(p1).size());
    }
    @Test
    ...
    public void TestContains1() {
        ...
        populateData2(p2);
        assertFalse(MapUtil.contains(p,p2));
    }
    @Test
    ...
    public void TestContains3() {
        ...
        populateData2(p2);
        assertTrue(MapUtil.contains(p,p2));
    }
}