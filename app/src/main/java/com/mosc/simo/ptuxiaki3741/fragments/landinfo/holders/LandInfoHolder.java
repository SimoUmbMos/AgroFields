package com.mosc.simo.ptuxiaki3741.fragments.landinfo.holders;
...
public class LandInfoHolder {
    ...
    public LandInfoHolder(View view, Resources resources,Land land,LandInfoHolderActions actions){
    ...
    private void init(Land land) {
        ...
        if(land == null){
            ...
            etLandName.setText(land.getTitle());
        }
